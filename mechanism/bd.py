...
def run_bd_sum_query(epsilon, sensitivity, raw_stream, window_size, round_, query_num, Flag_ = 0):
    dim = len(raw_stream[0])
    query_MRE_list = []
...
def run_bd_count_query(epsilon, sensitivity, raw_stream, window_size, round_, query_num, Flag_ = 0):
    dim = len(raw_stream[0])
    query_MRE_list = []
...
if __name__ == "__main__":
    ...
    # print(error_)
    bd_query_err = run_bd_sum_query(epsilon, sensitivity_p, raw_stream, window_size, round_, 1000)
    print(bd_query_err)