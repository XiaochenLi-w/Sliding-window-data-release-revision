...
def run_dsat_sum_query(epsilon, sensitivity, raw_stream, window_size, round_, query_num, Flag_ = 0):
    dim = len(raw_stream[0])
    query_MRE_list = []
...
def run_dsat_count_query(epsilon, sensitivity, raw_stream, window_size, round_, query_num, Flag_ = 0):
    dim = len(raw_stream[0])
    query_MRE_list = []
...
if __name__ == "__main__":
    ...
    # print(error_)
    dsat_query_err = run_dsat_sum_query(epsilon, sensitivity_p, raw_stream, window_size, round_, 1000)
    print(dsat_query_err)