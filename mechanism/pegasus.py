...
def run_pegasus(epsilon, sensitivity, raw_stream, window_size, round_, Flag_ = 0):
...
def run_pegasus_sum_query(epsilon, sensitivity, raw_stream, window_size, round_, query_num, Flag_ = 0):
    dim = len(raw_stream[0])
    query_MRE_list = []
...
def run_pegasus_count_query(epsilon, sensitivity, raw_stream, window_size, round_, query_num, Flag_ = 0):
    dim = len(raw_stream[0])
    query_MRE_list = []
    ...
    if Flag_ == 0:
        ...
        print('Pegasus count query DONE!')
...
if __name__ == "__main__":
    ...
    # print(error_)
    pegasus_query_err = run_pegasus_sum_query(epsilon, sensitivity_p, raw_stream, window_size, round_, 1000)
    print(pegasus_query_err)